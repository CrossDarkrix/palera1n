    ...
    def sshrd_sh(self, arg, arg2='', arg3=''):
        ...
        if not arg == '' and not arg == 'boot':
            ...
            if self.os_type == 'Linux':
                ...
                subprocess.run('{} -g {} {}'.format(os.path.join(self.default_path, 'ramdisk_{}'.format(self.os_type), 'pzb'), os.path.join('Firmware', '{}.trustcache'.format(plist_buddy_stdout.replace('\n', '').replace('"', ''))), self.ipsw_url), shell=True)
            ...
            if self.os_type == 'Linux':
                ...
                subprocess.run('{} -g {} {}'.format(os.path.join(self.default_path, 'ramdisk_{}'.format(self.os_type), 'pzb'), plist_buddy_stdout2.replace('\n', '').replace('"', ''), self.ipsw_url), shell=True)
