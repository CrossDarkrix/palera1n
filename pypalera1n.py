    ...
    def sshrd_sh(self, arg, arg2='', arg3=''):
        ...
        if not arg == '' and not arg == 'boot':
            ...
            if self.os_type == 'Linux':
                ...
                subprocess.run('{} -i {}.trustcache -o {} -M {} -T rtsc'.format(os.path.join(self.default_path, 'ramdisk_{}'.format(self.os_type), 'img4'), os.path.join('ramdisk_work', plist_buddy_stdout3.replace('\n', '').replace('"', '')), os.path.join('sshramdisk', 'trustcache.img4'), os.path.join('ramdisk_work', 'IM4M')), shell=True)
